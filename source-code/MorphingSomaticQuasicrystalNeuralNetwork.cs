...
public class MorphingSomaticQuasicrystalNeuralNetwork : MonoBehaviour 
{
	...
	public List <Vector3> INITIAL_CLUSTER_VECTOR_GROUP, INITIAL_FRUSTA_VECTOR_GROUP;  //made public to be accessible amidst 'MorphingSomaticQuasicrystalNeuralNetworkGenerator'. No values need be passed to these midst run time.
